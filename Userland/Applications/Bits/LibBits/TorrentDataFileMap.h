...
private:
    ...
    MultiFileMapperStream(Vector<NonnullRefPtr<MappedFilePosition>> files_positions, u64 total_length)
...
public:
    TorrentDataFileMap(ByteBuffer piece_hashes, i64 piece_length, Vector<NonnullRefPtr<LocalFile>> files);
